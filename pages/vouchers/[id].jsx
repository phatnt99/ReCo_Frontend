            ...
            <CardBody>
              <FormGroup row>
                ...
                <Col sm={10}>
                  ...
                  />
                  {errors.title && <FormFeedback style={{display: 'block'}}>Không để trống.</FormFeedback>}
                </Col>
              </FormGroup>
              <FormGroup row>
                <Label for="res-name" sm={2} style={style.label}>
                  ...
                  <Col md={4}>
                    <FormGroup>
                      ...
                      <input
                        ...
                        className={errors.fromTime ? "form-control is-invalid" : "form-control"}
                        {...register("fromTime", {
                          required: true,
                          validate: {
                            validDate: (v) =>
                      ...
                      {errors.fromTime &&
                        errors.fromTime.type == "validDate" && (
                          <FormFeedback style={{display: 'block'}}>Không được sau Đến ngày.</FormFeedback>
                        )}
                    </FormGroup>
                  </Col>
                  <Col md={4}>
                    <FormGroup>
                      ...
                      <input
                        ...
                        className={errors.toTime ? "form-control is-invalid" : "form-control"}
                        {...register("toTime", {
                          required: true,
                          validate: {
                            validDate: (v) =>
                      ...
                      {errors.toTime && errors.toTime.type == "validDate" && (
                        <FormFeedback style={{display: 'block'}}>Không được trước Từ ngày.</FormFeedback>
                      )}
                    </FormGroup>
                  </Col>
                  <Col md={4}>

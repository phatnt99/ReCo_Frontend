      ...
      <Modal toggle={() => setModalOpen(!modalOpen)} isOpen={modalOpen}>
        <Card className="card-pricing bg-gradient-success border-0 text-center">
          <CardHeader className="bg-transparent">
            ...
            {type == 3 && (
              <div className="float-center btn btn-default btn-sm">Đã hủy</div>
            )}
            {type == 4 && (
              <div className="float-center btn btn-default btn-sm">
                Đã hoàn thành
        ...
        >
          {restaurant.status == 1 && (
            <span className="badge-dot badge badge-">
              <i className="bg-success"></i>Đang chờ duyệt
            </span>
          )}
          {restaurant.status == 2 && (
            <span className="badge-dot badge badge-">
              <i className="bg-warning"></i>Đã duyệt
            </span>
          )}
          {restaurant.status == 3 && (
            <span className="badge-dot badge badge-">
              <i className="bg-warning"></i>Đã bị khóa
            </span>
          )}
        </td>
        <td

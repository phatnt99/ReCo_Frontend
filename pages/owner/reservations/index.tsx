...
function ReservationWaitApprove({ id, reload, setR }) {
  ...
  let query = `${spring.reservation}/type/1/owner/${ownerId}?page=${page}&size=${size}&size=${size}&sortable=${sort.field}&direction=${sort.direction}`;
  if (id != 0) {
...
function ReservationApproved({ id, reload, setR }) {
  ...
  // Data fetching
  const ownerId = localStorage.getItem("authId");
  let query = `${spring.reservation}/type/2/owner/${ownerId}?page=${page}&size=${size}&size=${size}&sortable=${sort.field}&direction=${sort.direction}`;
  if (id != 0) {
...
function ReservationCanceled({ id, reload, setR }) {
  ...
  // Data fetching
  const ownerId = localStorage.getItem("authId");
  let query = `${spring.reservation}/type/3/owner/${ownerId}?page=${page}&size=${size}&size=${size}&sortable=${sort.field}&direction=${sort.direction}`;
  if (id != 0) {
...
function ReservationHistory({ id, reload, setR }) {
  ...
  // Data fetching
  const ownerId = localStorage.getItem("authId");
  let query = `${spring.reservation}/type/4/owner/${ownerId}?page=${page}&size=${size}&size=${size}&sortable=${sort.field}&direction=${sort.direction}`;
  if (id != 0) {
...
function Reservation() {
  ...
  // Data fetching
  const ownerId = localStorage.getItem("authId");
  const query = `${spring.restaurant}/all/owner/${ownerId}`;
                ...
                <Row className="align-items-center">
                  ...
                  <Col className="text-right col-6">
                    <select className="form-control"
                      ...
                      {restaurants && restaurants.map(r => <option value={r.id}>{r.name}</option>)}
                    </select>
                  </Col>
                </Row>
              </CardHeader>

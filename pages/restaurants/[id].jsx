          ...
          <CardHeader className="border-0 mb-1">
            ...
            <Row>
              ...
              <Col className="d-flex justify-content-end">
                <BuildApprove model={model} action={approve} />
              </Col>
            </Row>
          </CardHeader>
            ...
            <CardBody>
              <FormGroup row>
                ...
                <Col sm={10}>
                  ...
                  />
                  {errors.name && (
                    <FormFeedback style={{display: 'block'}}>Không để trống.</FormFeedback>
                  )}
                </Col>
              </FormGroup>
              <FormGroup row>
                ...
                <Col sm={10}>
                  <textarea
                    id="res-introduction"
                    className={errors.introduction ? "form-control is-invalid" : "form-control"}
              ...
              <FormGroup>
                ...
                {errors.tagz && (
                  <FormFeedback style={{display: 'block'}}>Tags không được để trống!</FormFeedback>
                )}
              </FormGroup>
              <>
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <textarea
                        ...
                        className={errors.cuisine ? "form-control is-invalid" : "form-control"}
                        {...register("cuisine", {
                          required: true,
                          validate: (v) => v.trim() != "",
                        })}
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <textarea
                        ...
                        className={errors.space ? "form-control is-invalid" : "form-control"}
                        {...register("space", {
                          required: true,
                          validate: (v) => v.trim() != "",
                        })}
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <textarea
                        ...
                        className={errors.suitable ? "form-control is-invalid" : "form-control"}
                        {...register("suitable", {
                          required: true,
                          validate: (v) => v.trim() != "",
                        })}
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <textarea
                        ...
                        className={errors.parking ? "form-control is-invalid" : "form-control"}
                        {...register("parking", {
                          required: true,
                          validate: (v) => v.trim() != "",
                        })}
                  ...
                  <Col md={12}>
                    <FormGroup>
                      ...
                      <input
                        type="text"
                        id="res-time-open"
                        className={errors.openTime ? "form-control is-invalid" : "form-control"}
                        {...register("openTime", {
                          required: true,
                          validate: (v) => v.trim() != "",
                        })}
                    ...
                    <FormGroup>
                      ...
                      >
                        <input
                          ...
                          type="number"
                          id="res-price-from"
                          className={errors.minPrice ? "form-control is-invalid" : "form-control"}
                          {...register("minPrice", {
                            required: true,
                            pattern: /[0-9]+/,
                            validate: {
                              notEmpty: (v) => v.trim() != "",
                              validPrice: (v) => parseInt(v) <= parseInt(getValues("maxPrice")),
                            },
                          })}
                    ...
                    <FormGroup>
                      ...
                      >
                        <input
                          ...
                          type="number"
                          id="res-price-to"
                          className={errors.maxPrice ? "form-control is-invalid" : "form-control"}
                          {...register("maxPrice", {
                            required: true,
                            pattern: /[0-9]+/,
                            validate: {
                ...
                <Row form>
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      />
                      {errors.longtitude && (
                        <FormFeedback style={{display: 'block'}}>Sai định dạng.</FormFeedback>
                      )}
                    </FormGroup>
                  </Col>
                  <Col md={6}>
